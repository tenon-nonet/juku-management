...
export default function StudentFormPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-xl font-bold text-gray-100 mb-6">{isEdit ? '生徒編集' : '生徒新規登録'}</h1>
      <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">氏名 <span className="text-red-400">*</span></label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">氏名（フリガナ）</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">学年 <span className="text-red-400">*</span></label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">生年月日</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">学校名</label>
            <input value={form.schoolName} onChange={(e) => setForm({...form, schoolName: e.target.value})}
              className="w-full border border-gray-600 rounded-lg px-3 py-2 text-sm bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">保護者</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">ステータス</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">入塾日</label>
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button type="button" onClick={() => navigate('/students')} className="bg-gray-700 text-gray-200 px-6 py-2 rounded-lg text-sm font-medium hover:bg-gray-600">
            キャンセル
          </button>
        </div>
      </form>
