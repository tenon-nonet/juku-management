  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">成績記録</h1>
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-4 space-y-3">
          <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-200">新規登録</h2>
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <select value={form.studentId} onChange={(e) => setForm({ ...form, studentId: e.target.value })} required
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1.5 text-sm bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-400">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {results.length === 0 && <tr><td colSpan={7} className="px-4 py-8 text-center text-gray-500 dark:text-gray-400">記録がありません</td></tr>}
            {results.map((r) => (
              <tr key={r.id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <td className="px-4 py-3 text-gray-500 dark:text-gray-400">{r.examName}</td>
